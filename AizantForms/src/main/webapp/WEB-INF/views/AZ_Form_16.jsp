...
<body>
	...
	<b>T.	<u>ADVERSE EVENT AND CONCOMITANT MEDICATION  RECORD:</u></b>
	<br>
	<div id="border">
		...
		<div align="left">
			<br> &emsp;Recorded by : <input type="text" ng-model=" " placeholder="Name"><br>&emsp;&emsp;&emsp;&emsp;<input
					type="file" ng-model=""><br>&emsp;&emsp;&emsp;&emsp;<input type="date" ng-model=""> <br>
			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Sign & Date) <br>
		</div>
	</div>

		<div align="right">
			<br> &emsp;Reviewed by :<input type="text" ng-model=" " placeholder="Name"><br>&emsp;&emsp;&emsp;&emsp;<input
					type="file" ng-model=""><br>&emsp;&emsp;&emsp;&emsp;<input type="date" ng-model=""> <br>
			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Sign & Date) <br>
		</div>
	...
	<div id="box">
		...
		<div align="left">
			<br> &emsp;Principal Investigator : <input type="text" ng-model=""><br><input type="file" ng-model=""> <br><input type="date" ng-model=""><br>
			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Sign & Date) <br>
		</div>
	</div>
	<br>
