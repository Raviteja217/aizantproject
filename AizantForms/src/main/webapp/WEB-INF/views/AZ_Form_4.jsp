...
<body>
	...
	<div class="small">
		...
		<div align="right">
		<br> &emsp;Recorded by :<input type="text" ng-model=""> <input type="file" ng-model=""> <br>
		<input type="date" ng-model=" " style="align:right">
	...
	<table style="width: 90%">
		...
		<tr>
			...
			<td><input type="file" ng-model=""><input type="date" ng-model=" "></td>
	...
	<div id="border">
		...
		<table style="width: 100%">
			<tr>
				...
				<td>performed by :<input type="text" ng-model=""> <input type="file" ng-model=""><input type="date" ng-model=" "><br>
					 <br>(sign&date)
				</td>
				<td>verified by : <input type="text" ng-model=""><input type="file" ng-model=""><input type="date" ng-model=" "><br>
	...
	<footer><div align="right">
		...
		<br> &emsp;Reviewed by : <input type="text" ng-model=""><br><input type="file" ng-model=""> <br>
		<input type="date" ng-model=" "><br>
