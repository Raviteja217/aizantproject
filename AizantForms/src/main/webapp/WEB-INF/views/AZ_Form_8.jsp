...
<body>
	...
	<table style="width: 100%">
		...
		<tr>
			...
			<td><input type="text" ng-model=""><input type="file" ng-model=""><input type="date" ng-model=""></td>
	...
	<table style="width: 100%">
		...
		<tr>
			...
			<td><input type="time" ng-model=""></td>
			<td><input type="text" ng-model=""></td>
			<td><input type="text" ng-model=""><br><input type="file" ng-model=""><input type="date" ng-model=""></td>
			<td><textarea rows="2" cols="15"></textarea></td>
	...
	<footer>
		<div align="right">
			...
			<br> &emsp;Reviewed by : <input type="text" ng-model=""><br><input type="file" ng-model="">
			<br> <input type="date" ng-model=" "><br>
