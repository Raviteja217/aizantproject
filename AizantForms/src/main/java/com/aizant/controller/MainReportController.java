...
/*create mainReport*/
	...
	public ModelAndView storemainReport(@Valid @ModelAttribute("MainReport") MainReport mainReport, BindingResult result) {
		...
		return new ModelAndView("redirect:/display_mainReports");
	}
	...
	@RequestMapping("/display_mainReports")
	public ModelAndView retriveRecords() throws Exception {
		ModelAndView m1 = new ModelAndView("display_mainReports");
	...
	public ModelAndView deletemainReport(@RequestParam int id) {
		...
		ModelAndView model2 = new ModelAndView("display_mainReports");
		return model2;
	}
