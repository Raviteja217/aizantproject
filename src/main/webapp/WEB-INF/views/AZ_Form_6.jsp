...
<body>
	<div class="allbody" ng-app="">
		...
		<hr>
		<br> <b><u>G. MEDICAL EXAMINATION (CHECK-IN) : </u></b> <br>
		<br> Start Time: <input type="time" ng-model="" /> <br> <br>
		...
		<div id="border">
				...
				<tr>
					...
					<td>
						<table style="width: 100%">
							...
							<tr>
								<td>Radial Pulse rate (Beats/ min) :</td>
								<td><input type="text" ng-model=""></td>
								</td>
			...
			<p>
				General physical examination:&emsp;&emsp; &emsp;&emsp; <input
					type="checkbox">Normal &emsp;&emsp; &emsp;&emsp;
				&emsp;&emsp; &emsp;&emsp; <input type="checkbox">Abnormal
			</p>
					...
					<td>
						<table style="width: 100%">
							...
							<tr>
								...
								<td><textarea rows="2" cols="15" style="width: 99%"></textarea></td>
		...
		<p>*RS: Respiratory System CVS: Cardio Vascular System CNS:
		...
		<p>
			Is the subject fit for Check-in? &emsp;&emsp; &emsp;&emsp; <select>
		...
		<footer> <br>
		&emsp;Performed by : <input type="text" ng-model="pin" placeholder="Enter pin here"><a href="pin_user?pin={{pin}}">OK</a>
		<br>
		&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Sign & Date) <br>

		<div align="right">
			<br> &emsp;Reviewed by : <input type="text" ng-model="pin" placeholder="Enter pin here"><a href="pin_user?pin={{pin}}">OK</a><br> &emsp;&emsp;&emsp;&emsp;(Sign & Date)
		</div>
		<div align="left">Page 5 of 15</div>
		</footer>
	</div>
	<div align="center">
		<a href="Form5" class="btn btn-primary" type="button">PREVIOUS</a>&emsp;&emsp;
		<a href="#" class="btn btn-primary" type="button">SUBMIT</a>&emsp;&emsp;
		<a href="Form7" class="btn btn-primary">NEXT</a>
	</div>
	</div>
</body>
</html>