...
<body>
	...
	<div class="container"><%-- div class="row"> <div
		...
		toppad"> <div class="panel panel-info"> <div class="panel-heading">
		<%-- <h3 class="panel-title">${user.username}</h3> --%> <div
		class="panel-title">Edit Project</div></div>
